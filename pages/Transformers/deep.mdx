...
There are two things about [this post](http://jalammar.github.io/illustrated-gpt2/#part-2-illustrated-self-attention) that make it an absolutely world class example of good instructional design. One are those stunningly intuitive and clever diagrams of the query, key, and value process behaving like a post-it note being used to search through a variety of manila folders. The other is how painstaking he is about showing you every single parameter in every matrix of the entire system as a whole.
